...
def config_writer(base_file, NoC_file):
    ...
    pattern = "data_file = "
    subst = "data_file = /home/mirka/ratatoskr/bin/urand/collectes/c4/" + NoC_file
    #Create temp file
    fh, abs_path = mkstemp()
...
# 3. run simulation
    ...
    #for j in range(8,9,1):
        ...
        #for i in range(1):
            ...
            base_file = "config_template_10%.ini"
            ...
            if i%100==0:
                filename = "/home/mirka/ratatoskr/bin/urand/collectes/scores/hot10/"+name
                with open(filename, 'wb') as f:
    ...
    for j in range(15,17,1):
        ...
        #for i in range(1):
            ...
            if i%100==0:
                filename = "/home/mirka/ratatoskr/bin/urand/collectes/scores/hot30/"+name
                with open(filename, 'wb') as f:
                    pickle.dump(report_data, f)
